...
import org.apache.poi.xmlbeans.SchemaAnnotation;
import org.apache.poi.xmlbeans.SchemaAttributeGroup;
import org.apache.poi.xmlbeans.SchemaAttributeModel;
import org.apache.poi.xmlbeans.SchemaComponent;
import org.apache.poi.xmlbeans.SchemaGlobalAttribute;
import org.apache.poi.xmlbeans.SchemaGlobalElement;
import org.apache.poi.xmlbeans.SchemaIdentityConstraint;
import org.apache.poi.xmlbeans.SchemaModelGroup;
import org.apache.poi.xmlbeans.SchemaParticle;
...
import org.apache.poi.xmlbeans.impl.values.XmlIntegerImpl;
import org.apache.poi.xmlbeans.impl.values.XmlStringImpl;
        ...
        SchemaTypeSystem
{
    ...
    private XQuerySchemaTypeSystem()
    {
        ...
        // UR types
        setupType(SchemaType.BTC_ANY_TYPE, "anyType", "org.apache.poi.xmlbeans.XmlObject");
        setupType(SchemaType.BTC_ANY_SIMPLE, "anySimpleType", "org.apache.poi.xmlbeans.XmlAnySimpleType");
        setupType(BTC_ANY_ATOMIC, "anyAtomicType", null);

        // primitives
        setupType(SchemaType.BTC_BOOLEAN, "boolean", "org.apache.poi.xmlbeans.XmlBoolean");
        setupType(SchemaType.BTC_BASE_64_BINARY, "base64Binary", "org.apache.poi.xmlbeans.XmlBase64Binary");
        setupType(SchemaType.BTC_HEX_BINARY, "hexBinary", "org.apache.poi.xmlbeans.XmlHexBinary");
        setupType(SchemaType.BTC_ANY_URI, "anyURI", "org.apache.poi.xmlbeans.XmlAnyURI");
        setupType(SchemaType.BTC_QNAME, "QName", "org.apache.poi.xmlbeans.XmlQName");
        setupType(SchemaType.BTC_NOTATION, "NOTATION", "org.apache.poi.xmlbeans.XmlNOTATION");
        setupType(SchemaType.BTC_FLOAT, "float", "org.apache.poi.xmlbeans.XmlFloat");
        setupType(SchemaType.BTC_DOUBLE, "double", "org.apache.poi.xmlbeans.XmlDouble");
        setupType(SchemaType.BTC_DECIMAL, "decimal", "org.apache.poi.xmlbeans.XmlDecimal");
        setupType(SchemaType.BTC_STRING, "string", "org.apache.poi.xmlbeans.XmlString");

        setupType(SchemaType.BTC_DURATION, "duration", "org.apache.poi.xmlbeans.XmlDuration");
        setupType(SchemaType.BTC_DATE_TIME, "dateTime", "org.apache.poi.xmlbeans.XmlDateTime");
        setupType(SchemaType.BTC_TIME, "time", "org.apache.poi.xmlbeans.XmlTime");
        setupType(SchemaType.BTC_DATE, "date", "org.apache.poi.xmlbeans.XmlDate");
        setupType(SchemaType.BTC_G_YEAR_MONTH, "gYearMonth", "org.apache.poi.xmlbeans.XmlGYearMonth");
        setupType(SchemaType.BTC_G_YEAR, "gYear", "org.apache.poi.xmlbeans.XmlGYear");
        setupType(SchemaType.BTC_G_MONTH_DAY, "gMonthDay", "org.apache.poi.xmlbeans.XmlGMonthDay");
        setupType(SchemaType.BTC_G_DAY, "gDay", "org.apache.poi.xmlbeans.XmlGDay");
        setupType(SchemaType.BTC_G_MONTH, "gMonth", "org.apache.poi.xmlbeans.XmlGMonth");

        // derived numerics
        setupType(SchemaType.BTC_INTEGER, "integer", "org.apache.poi.xmlbeans.XmlInteger");
        setupType(SchemaType.BTC_LONG, "long", "org.apache.poi.xmlbeans.XmlLong");
        setupType(SchemaType.BTC_INT, "int", "org.apache.poi.xmlbeans.XmlInt");
        setupType(SchemaType.BTC_SHORT, "short", "org.apache.poi.xmlbeans.XmlShort");
        setupType(SchemaType.BTC_BYTE, "byte", "org.apache.poi.xmlbeans.XmlByte");
        setupType(SchemaType.BTC_NON_POSITIVE_INTEGER, "nonPositiveInteger", "org.apache.poi.xmlbeans.XmlNonPositiveInteger");
        setupType(SchemaType.BTC_NEGATIVE_INTEGER, "negativeInteger", "org.apache.poi.xmlbeans.XmlNegativeInteger");
        setupType(SchemaType.BTC_NON_NEGATIVE_INTEGER, "nonNegativeInteger", "org.apache.poi.xmlbeans.XmlNonNegativeInteger");
        setupType(SchemaType.BTC_POSITIVE_INTEGER, "positiveInteger", "org.apache.poi.xmlbeans.XmlPositiveInteger");
        setupType(SchemaType.BTC_UNSIGNED_LONG, "unsignedLong", "org.apache.poi.xmlbeans.XmlUnsignedLong");
        setupType(SchemaType.BTC_UNSIGNED_INT, "unsignedInt", "org.apache.poi.xmlbeans.XmlUnsignedInt");
        setupType(SchemaType.BTC_UNSIGNED_SHORT, "unsignedShort", "org.apache.poi.xmlbeans.XmlUnsignedShort");
        setupType(SchemaType.BTC_UNSIGNED_BYTE, "unsignedByte", "org.apache.poi.xmlbeans.XmlUnsignedByte");

        // derived strings
        setupType(SchemaType.BTC_NORMALIZED_STRING, "normalizedString", "org.apache.poi.xmlbeans.XmlNormalizedString");
        setupType(SchemaType.BTC_TOKEN, "token", "org.apache.poi.xmlbeans.XmlToken");
        setupType(SchemaType.BTC_NAME, "Name", "org.apache.poi.xmlbeans.XmlName");
        setupType(SchemaType.BTC_NCNAME, "NCName", "org.apache.poi.xmlbeans.XmlNCName");
        setupType(SchemaType.BTC_LANGUAGE, "language", "org.apache.poi.xmlbeans.XmlLanguage");
        setupType(SchemaType.BTC_ID, "ID", "org.apache.poi.xmlbeans.XmlID");
        setupType(SchemaType.BTC_IDREF, "IDREF", "org.apache.poi.xmlbeans.XmlIDREF");
        setupType(SchemaType.BTC_IDREFS, "IDREFS", "org.apache.poi.xmlbeans.XmlIDREFS");
        setupType(SchemaType.BTC_ENTITY, "ENTITY", "org.apache.poi.xmlbeans.XmlENTITY");
        setupType(SchemaType.BTC_ENTITIES, "ENTITIES", "org.apache.poi.xmlbeans.XmlENTITIES");
        setupType(SchemaType.BTC_NMTOKEN, "NMTOKEN", "org.apache.poi.xmlbeans.XmlNMTOKEN");
        setupType(SchemaType.BTC_NMTOKENS, "NMTOKENS", "org.apache.poi.xmlbeans.XmlNMTOKENS");
    ...
    public void fillInType(int btc)
    {
        ...
        if (pattern != null)
        {
            org.apache.poi.xmlbeans.impl.regex.RegularExpression p = null;
            try { p = org.apache.poi.xmlbeans.impl.regex.SchemaRegularExpression.forPattern(pattern); }
            catch (org.apache.poi.xmlbeans.impl.regex.ParseException e) { assert false; }
            result.setPatterns(new org.apache.poi.xmlbeans.impl.regex.RegularExpression[] {p});
        }
