...
import org.apache.poi.xmlbeans.impl.validator.ValidatingXMLInputStream;

import org.apache.poi.xmlbeans.impl.store.Locale;
...
import org.apache.poi.xmlbeans.XmlFactoryHook;
...
import org.apache.poi.xmlbeans.xml.stream.XMLStreamException;
...
public abstract class SchemaTypeLoaderBase implements SchemaTypeLoader
{
    ...
    private static final Method _pathCompiler = getMethod( "org.apache.poi.xmlbeans.impl.store.Path", "compilePath", new Class[] { String.class, XmlOptions.class } );
    private static final Method _queryCompiler = getMethod( "org.apache.poi.xmlbeans.impl.store.Query", "compileQuery", new Class[] { String.class, XmlOptions.class } );
