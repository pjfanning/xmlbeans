...
import org.apache.poi.xmlbeans.impl.common.XPath.XPathCompileException;
import org.apache.poi.xmlbeans.impl.common.XPath.ExecutionContext;
...
public abstract class Path
{
    ...
    static
    {
        ...
        String id = "META-INF/services/org.apache.poi.xmlbeans.impl.store.PathDelegate.SelectPathInterface";
    ...
    private static Path createXdkCompiledPath(String pathExpr, String currentVar)
    {
        ...
        if (_xdkCompilePath == null)
        {
            try
            {
                Class xdkImpl = Class.forName("org.apache.poi.xmlbeans.impl.store.OXQXBXqrlImpl");
    ...
    private static Path createXqrlCompiledPath(String pathExpr, String currentVar)
    {
        ...
        if (_xqrlCompilePath == null)
        {
            try
            {
                Class xqrlImpl = Class.forName("org.apache.poi.xmlbeans.impl.store.XqrlImpl");
    ...
    private static Path createXqrl2002CompiledPath(String pathExpr, String currentVar)
    {
        ...
        if (_xqrl2002CompilePath == null)
        {
            try
            {
                Class xqrlImpl = Class.forName("org.apache.poi.xmlbeans.impl.store.Xqrl2002Impl");
