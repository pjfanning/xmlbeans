...
import org.apache.poi.xmlbeans.impl.store.Saver.TextSaver;
...
import org.apache.poi.xmlbeans.impl.values.NamespaceManager;
...
public final class Public2
{
    private static Locale newLocale ( Saaj saaj )
    {
        ...
        if (saaj != null)
        {
            ...
            options.put( org.apache.poi.xmlbeans.impl.store.Saaj.SAAJ_IMPL, saaj );
        }
