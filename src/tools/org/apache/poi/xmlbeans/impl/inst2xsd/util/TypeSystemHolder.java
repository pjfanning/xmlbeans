 ...
 */
package org.apache.poi.xmlbeans.impl.inst2xsd.util;
...
public class TypeSystemHolder
{
    ...
    private static org.apache.poi.xmlbeans.impl.xb.xsdschema.SchemaDocument.Schema getTopLevelSchemaElement(SchemaDocument schDoc,
        String tns)
    {
        org.apache.poi.xmlbeans.impl.xb.xsdschema.SchemaDocument.Schema sch = schDoc.getSchema();
        if (sch==null)
        {
            sch = schDoc.addNewSchema();
            sch.setAttributeFormDefault(org.apache.poi.xmlbeans.impl.xb.xsdschema.FormChoice.Enum.forString("unqualified"));
            sch.setElementFormDefault(org.apache.poi.xmlbeans.impl.xb.xsdschema.FormChoice.Enum.forString("qualified"));
            if (!tns.equals(""))
    ...
    private void fillUpGlobalElement(Element globalElement, SchemaDocument schDoc, String tns)
    {
        ...
        org.apache.poi.xmlbeans.impl.xb.xsdschema.SchemaDocument.Schema sch = getTopLevelSchemaElement(schDoc, tns);

        org.apache.poi.xmlbeans.impl.xb.xsdschema.TopLevelElement topLevelElem = sch.addNewElement();
    ...
    protected void fillUpLocalElement(Element element, org.apache.poi.xmlbeans.impl.xb.xsdschema.LocalElement localSElement, String tns)
    {
    ...
    private void fillUpTypeOnElement(Type elemType, org.apache.poi.xmlbeans.impl.xb.xsdschema.Element parentSElement, String tns)
    {
        ...
        {
            org.apache.poi.xmlbeans.impl.xb.xsdschema.LocalComplexType localComplexType = parentSElement.addNewComplexType();
            fillUpContentForComplexType(elemType, localComplexType, tns);
        }
    }

    private void fillUpEnumeration(Type type, org.apache.poi.xmlbeans.impl.xb.xsdschema.Element parentSElement)
    {
        assert type.isEnumeration() && !type.isComplexType() : "Enumerations must be on simple types only.";
        org.apache.poi.xmlbeans.impl.xb.xsdschema.RestrictionDocument.Restriction restriction = parentSElement.addNewSimpleType().addNewRestriction();
        ...
        if (type.isQNameEnumeration())
        {
            for (int i = 0; i < type.getEnumerationQNames().size(); i++)
            {
                ...
                org.apache.poi.xmlbeans.impl.xb.xsdschema.NoFixedFacet enumSElem = restriction.addNewEnumeration();
    ...
    private void fillUpAttributesInComplexTypesSimpleContent(Type elemType,
        org.apache.poi.xmlbeans.impl.xb.xsdschema.SimpleExtensionType sExtension, String tns)
    {
        for (int i = 0; i < elemType.getAttributes().size(); i++)
        {
            Attribute att = (Attribute) elemType.getAttributes().get(i);
            org.apache.poi.xmlbeans.impl.xb.xsdschema.Attribute sAttribute = sExtension.addNewAttribute();
            fillUpLocalAttribute(att, sAttribute, tns);
        }
    }

    private void fillUpAttributesInComplexTypesComplexContent(Type elemType,
        org.apache.poi.xmlbeans.impl.xb.xsdschema.ComplexType localSComplexType, String tns)
    {
        for (int i = 0; i < elemType.getAttributes().size(); i++)
        {
            Attribute att = (Attribute) elemType.getAttributes().get(i);
            org.apache.poi.xmlbeans.impl.xb.xsdschema.Attribute sAttribute = localSComplexType.addNewAttribute();
            fillUpLocalAttribute(att, sAttribute, tns);
        }
    }

    protected void fillUpLocalAttribute(Attribute att, org.apache.poi.xmlbeans.impl.xb.xsdschema.Attribute sAttribute, String tns)
    {
        if (att.isRef())
        {
        ...
        else
        {
            ...
            if (att.isOptional())
                sAttribute.setUse(org.apache.poi.xmlbeans.impl.xb.xsdschema.Attribute.Use.OPTIONAL);
        }
    }

    protected void fillUpContentForComplexType(Type type, org.apache.poi.xmlbeans.impl.xb.xsdschema.ComplexType sComplexType, String tns)
    {
        if (type.getContentType()==Type.COMPLEX_TYPE_SIMPLE_CONTENT)
        {
            org.apache.poi.xmlbeans.impl.xb.xsdschema.SimpleContentDocument.SimpleContent simpleContent = sComplexType.addNewSimpleContent();
            ...
            org.apache.poi.xmlbeans.impl.xb.xsdschema.SimpleExtensionType ext = simpleContent.addNewExtension();
        ...
        else
        {
            ...
            org.apache.poi.xmlbeans.impl.xb.xsdschema.ExplicitGroup explicitGroup;
            ...
            for (int i = 0; i < type.getElements().size(); i++)
            {
                ...
                org.apache.poi.xmlbeans.impl.xb.xsdschema.LocalElement childLocalElement = explicitGroup.addNewElement();
    ...
    private void fillUpGlobalAttribute(Attribute globalAttribute, SchemaDocument schDoc, String tns)
    {
        ...
        org.apache.poi.xmlbeans.impl.xb.xsdschema.TopLevelAttribute topLevelAtt = sch.addNewAttribute();
        ...
        {
            //org.apache.poi.xmlbeans.impl.xb.xsdschema.LocalSimpleType localSimpleType = topLevelAtt.addNewSimpleType();
            throw new IllegalStateException();
        }
    }

    private static void fillUpElementDocumentation(org.apache.poi.xmlbeans.impl.xb.xsdschema.Element element, String comment)
    {
        if (comment!=null && comment.length()>0)
        {
            org.apache.poi.xmlbeans.impl.xb.xsdschema.DocumentationDocument.Documentation documentation = element.addNewAnnotation().addNewDocumentation();
            documentation.set(org.apache.poi.xmlbeans.XmlString.Factory.newValue(comment));
        }
    }
    ...
    private void fillUpGlobalType(Type globalType, SchemaDocument schDoc, String tns)
    {
        ...
        org.apache.poi.xmlbeans.impl.xb.xsdschema.TopLevelComplexType topLevelComplexType = sch.addNewComplexType();
