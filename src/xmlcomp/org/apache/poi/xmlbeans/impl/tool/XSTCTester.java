...
import org.apache.poi.xmlbeans.impl.xb.ltgfmt.TestsDocument;
import org.apache.poi.xmlbeans.impl.xb.ltgfmt.FileDesc;
...
public class XSTCTester
{
    ...
    public static TestCase[] parseLTGFile(File ltgFile, Collection outerErrors)
    {
        ...
        try
        {
            ...
            org.apache.poi.xmlbeans.impl.xb.ltgfmt.TestCase[] testCases = doc.getTests().getTestArray();
