...
import org.apache.poi.xmlbeans.samples.datetime.ImportantDate;
...
public class DateTime {
    ...
    * (java.util.Date, java.util.Calendar) and org.apache.poi.xmlbeans.GDate.
    */
       ...
       for (int i=0;i<impdate.length;i++){
           ...
           if (i==0){
               ...
               for (int j=0;j<holiday.length;j++){
                   if (j==0){
                       //XmlDate to java.util.Calendar,org.apache.poi.xmlbeans.GDate, java.util.Date
               ...
               //XmlTime to java.util.Calendar, org.apache.poi.xmlbeans.GDate, java.util.Date
               ...
               //XmlDuration to org.apache.poi.xmlbeans.GDuration
